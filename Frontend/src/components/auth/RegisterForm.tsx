    ...
    <Card className="border-0 shadow-xl bg-white/90 backdrop-blur-sm">
      ...
      <CardContent className="space-y-4 px-4 md:px-6">
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          ...
          <Button
            type="submit"
            className="w-full bg-[#D2DD27] hover:bg-[#A8B823] text-gray-600 font-medium py-2.5 transition-all duration-200 transform hover:scale-[1.02] text-sm md:text-base"
            disabled={loading}
          >
